...
dy68f_scrapper.action(action='write',attribute='type="text"',input_value=DY68F_EMAIL,message='phone input...')
dy68f_scrapper.action(action='send',attribute='type="password"',input_value=DY68F_PASSWORD,message='password input...')
dy68f_scrapper.action(action='click',attribute='class="loginin btncolor"',message='going to market list...')
